...
<div class="container">
  ...
  <form action="{{route('add_category_product')}}" method="POST" class="form-horizontal" role="form">
     <div class="form-group">
      <label for="name" class="col-sm-3 control-label">Tên Danh Mục</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" name="category_name" id="categoty_name">
      </div>
    <div class="form-group">
      <label for="about" class="col-sm-3 control-label">Mô Tả</label>
      <div class="col-sm-9">
        <textarea class="form-control" rows="5" name="category_desc"></textarea>
      </div>
    </div> <!-- form-group // -->
    <div class="form-group">
    ...
    <div class="form-group">
      <div class="col-sm-offset-3 col-sm-9">
        ...
        <a href="{{route('admin.all_category')}}" class=" btn btn-primary"> Liệt Kê Danh Mục Sản Phẩm</a>
      </div>
      @if (\Session::has('msg'))
      <div class="col-sm-offset-3 col-sm-9">
